...
for i in iter:
    ...
    print(i)
    dis_final1.append(expect1(10,i,num_r,init,x_min,stepsize,5,0.2))#Sparsification
    print(i)
    dis_final2.append(expect3(10,i,num_r,init,x_min,stepsize,5,0.2))#Shift
...
plt.plot(iter,dis_final1,linewidth = 1,marker= '+',markersize = 10, label = 'SGD-NICE')
plt.plot(iter,dis_final2,linewidth = 1,marker= 'x',markersize = 10,label = 'L-SVRG-NICE')
